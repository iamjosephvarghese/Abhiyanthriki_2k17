        ...
        mSelectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setType("image/*");
                    ...
                    Toast.makeText(Selfie.this,"Please Fill In The Necessary Fields.",Toast.LENGTH_LONG).show();
                }
        ...
        if(requestCode == GALLERY_INTENT && resultCode == RESULT_OK){
            ...
            sRef.putFile(uri,metadata).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(Selfie.this,"Image Uploaded",Toast.LENGTH_LONG).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Selfie.this,"Uh-oh, an error occurred!",Toast.LENGTH_LONG).show();
                }
            });
